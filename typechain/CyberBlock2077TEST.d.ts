...
interface CyberBlock2077TESTInterface extends ethers.utils.Interface {
  functions: {
...
export class CyberBlock2077TEST extends BaseContract {
  ...
  interface: CyberBlock2077TESTInterface;
